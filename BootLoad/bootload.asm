; *-------------------------------------------------------*
; |                                                       |
; |   File Name: Bootload.asm                             |
; |   Description: Loads the Operating System             |
; |                                                       |
...
OEMLabel		db "VSOSBOOT"	; Disk label
...
VolumeLabel		db "VSOS       "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; Visual Software OS Kernel FileName
