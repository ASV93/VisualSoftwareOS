...
; |                                                       |
; |   File Name: Misc.asm                                 |
; |   Description: Various sub-routines of the Kernel     |
; |                                                       |
...
; ------------------------------------------------------------------
; os_get_api_version -- Return current version of VSOS API
...
os_fatal_error:
	...
	.msg_inform		db '(X) FATAL OPERATING SYSTEM ERROR', 13, 10, 0
