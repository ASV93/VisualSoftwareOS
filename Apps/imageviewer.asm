; *-------------------------------------------------------*
; |                                                       |
; |   File Name: ImageViewer.asm                          |
; |   Description: PCX Image Viewer (300x200x8)		      |
; |                                                       |
...
valid_txt_extension:
	...
	mov cx, 10001111b ;11110000b		; Black text on white background
	call os_draw_background
	popa
...
txt_start:
	...
	mov bl, 10001111b ;11110000b		; Black text on white background
	mov dh, 2
	mov dl, 0
	mov si, 80
	mov di, 23
